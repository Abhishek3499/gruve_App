...
class FinalHomeFeed extends StatelessWidget {
  const FinalHomeFeed({super.key});

  @override
  Widget build(BuildContext context) {
    final users = DummyUsers.getOtherUsers(); // Only show other users in feed
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        // ✅ WORKING: Tappable profile image (goes to UserProfileScreen)
                        NavigationHelper.buildTappableUserAvatar(
                          context: context,
                          user: user,
                          radius: 25,
                        ),
                        ...
                        // ✅ WORKING: Tappable username (goes to UserProfileScreen)
                        Expanded(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Tap on avatar or username above to view user profile',
                          style: const TextStyle(
