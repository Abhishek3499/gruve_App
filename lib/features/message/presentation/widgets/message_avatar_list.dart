...
class MessageAvatarList extends ConsumerStatefulWidget {
  const MessageAvatarList({super.key});

  @override
  ConsumerState<MessageAvatarList> createState() => _MessageAvatarListState();
}

class _MessageAvatarListState extends ConsumerState<MessageAvatarList> {
  ...
  Widget build(BuildContext context) {
    final p = ref.watch(userNotifierProvider);
