...
import 'package:gruve_app/features/auth/presentation/controller/logout_controller.dart';
...
class LogoutNotifier extends Notifier<LogoutUiState> {
  ...
  Future<void> logout({BuildContext? context}) async {
    AppLogger.d('[LogoutNotifier] Starting logout process');
    ...
    try {
      if (refreshToken != null && refreshToken.isNotEmpty) {
        ...
        if (result.errorMessage != null) {
          ...
          AppLogger.d('[LogoutNotifier] Logout API completed');
        }
      } else {
        AppLogger.d(
      ...
      if (context != null && context.mounted) {
        ...
        AppLogger.d('[LogoutNotifier] Resetting local providers');
        ...
        AppLogger.d('[LogoutNotifier] Local providers cleared');
      }
      ...
      AppLogger.d('[LogoutNotifier] Logout exception: $e');
  ...
  void resetNavigationFlag() {
    if (state.shouldNavigate) {
      AppLogger.d('[LogoutNotifier] Navigation flag reset');
      state = LogoutUiState(
        isLoading: state.isLoading,
        errorMessage: state.errorMessage,
      );
