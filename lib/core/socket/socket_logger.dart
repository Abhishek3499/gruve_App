...
class SocketLogger {
  ...
  static Future<void> stopCapture() async {
    ...
    AppLogger.d(
      '🔌 [SOCKET LOGGER] Stopped capturing. Logs saved to socket_logs.txt',
    );
  ...
  static void logConnectionState(
    ...
    logEvent(
      'CONNECTION_STATE',
      'State changed',
      data: {'from': fromState, 'to': toState, 'reason': reason, ...?data},
    );
  }
  ...
  static void logError(
    ...
    logEvent('ERROR', error, data: {'context': context, 'data': data});
  }
  ...
  static void printSummary() {
    ...
    final heartbeatCount = _logs
        .where((log) => log.contains('HEARTBEAT'))
        .length;
